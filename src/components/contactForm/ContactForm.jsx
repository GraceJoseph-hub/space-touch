    ...
    >
      <div className="flex flex-col gap-6 dark:text-light">
        ...
        <p className="text-grey">
          ...
          phone. Drop us a line so we can talk further about that.
        </p>
        <div>
...
// Hi there, We are available 24/7 on social media, e-mail or
          // phone. Drop a message so we can talk more.
